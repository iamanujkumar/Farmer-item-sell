...
const Cart = () => {
    ...
    const deleteCart = (item) => {
        dispatch(deleteFromCart({ _id: item._id })); // Pass _id instead of full item
    };
                            ...
                            {cartItems.length > 0 ? (
                                <>
                                    {cartItems.map((item, index) => {
                                        const { _id, itemName, quantity, price, imagesUrl, city } = item;
                                        return (
                                                ...
                                                <div className="mb-2 flex">
                                                    <div className="min-w-24 flex">
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex h-7 w-7 items-center justify-center bg-gray-200 rounded-full"
                                                        >
                                                            +
                                                        </button>
                                                    </div>
